		...
		android.media.AudioRecord.OnRecordPositionUpdateListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SkillStore.WavFileReader.WavRecorder, SkillStore, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", WavRecorder.class, __md_methods);
	}


	public WavRecorder () throws java.lang.Throwable
	{
		super ();
		if (getClass () == WavRecorder.class)
			mono.android.TypeManager.Activate ("SkillStore.WavFileReader.WavRecorder, SkillStore, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public WavRecorder (int p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == WavRecorder.class)
			mono.android.TypeManager.Activate ("SkillStore.WavFileReader.WavRecorder, SkillStore, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0 });
	}
